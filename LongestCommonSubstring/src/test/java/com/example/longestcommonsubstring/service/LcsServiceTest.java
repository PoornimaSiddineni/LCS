package com.example.longestcommonsubstring.service;
...
class LcsServiceTest {
    ...
    public void setUp() {
        ...
        substrs1 = new Substring("1", Arrays.asList("abc","defabc","jgdabc"),1,Arrays.asList("abc"));
        substrs2 = new Substring("10",Arrays.asList("123abc","defa123bc","jgd123abc"),1,Arrays.asList("abc"));
    ...
    public void givenId_whenGetById_thenReturnObject(){
        ...
        // when
        Substring saved = lcsService.getById(substrs1.getId()).get();
